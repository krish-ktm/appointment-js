        ...
        <form onSubmit={onSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div>
                <h3 className="text-sm font-medium text-gray-900 mb-2">{t.date}</h3>
              ...
              <div>
                <h3 className="text-sm font-medium text-gray-900 mb-2">{t.timeSlot}</h3>
                <TimeSlotSelector
                  timeSlots={timeSlots}
            ...
            <div className="space-y-4">
              ...
              <motion.button
                ...
                className={`w-full py-3 px-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl font-medium shadow-lg shadow-blue-500/20 hover:shadow-blue-500/30 hover:from-blue-700 hover:to-blue-800 transition-all duration-200 ${
