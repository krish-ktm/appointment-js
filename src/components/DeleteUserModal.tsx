          ...
          <div className="p-6 space-y-6">
            ...
            <div className="flex justify-end gap-3 pt-4">
              ...
              <button
                onClick={onConfirm}
                disabled={loading}
                className={`px-4 py-2.5 text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500/20 transition-colors ${
