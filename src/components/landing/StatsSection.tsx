...
export function StatsSection() {
  return (
    <div className={`py-20 bg-gradient-to-b ${gradients.primary.light}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            >
              ...
              <div className="relative bg-gradient-to-r from-white/50 to-white/30 backdrop-blur-md p-8 rounded-xl shadow-lg border border-white/40 group-hover:border-white/60 transition-all duration-300 overflow-hidden">
